  ...
  return (
    <DrawerContentScrollView {...props}>
      <View style={{ flexDirection: 'row', margin: 0, backgroundColor: 'black', height: 75, alignItems: 'center' }}>
        ...
        <View>
          <View>
            <Text style={{ fontSize: 20, color: 'white', fontWeight: 'bold' }}>{currentUser ? `${currentUser.firstName} ${currentUser.lastName}` : 'ব্যবহারকারী সংগ্রহ করা হচ্ছে'}</Text>
          </View>
          <View>
            <Text style={{ fontSize: 14, color: 'white' }}>{currentUser ? currentUser.username : 'ব্যবহারকারী সংগ্রহ করা হচ্ছে'}</Text>
          </View>
        </View>
      </View>
      ...
      <Pressable style={{ paddingLeft: 20, marginVertical: 10 }} onPress={() => Auth.signOut()}>
        <Text style={{ fontWeight: 'bold' }}>প্রস্থান</Text>
      </Pressable>
